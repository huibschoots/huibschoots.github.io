...
RST is also based on and related to [Lessons Learned in Software Testing: A Context-Driven Approach](https://www.amazon.com/exec/obidos/ASIN/0471081124/satisinc){:target="\_blank"}, by Cem Kaner, James Bach, and Bret Pettichord as well as the self-education and independent thinking approach to life depicted in James’ book, [Secrets of a Buccaneer-Scholar](https://amzn.to/2Gip8ib){:target="\_blank"}
...
### The Book
![Cartoon dawn by Damian Synadinos](/assets/img/huib.png){: width="200" .right}
...
The RST reading list is here: 
The great resoruces list is here: