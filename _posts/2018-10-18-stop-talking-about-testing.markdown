...
The testing story by Rapid Software Testing can help you tell that story. Tell a story about the product, what you saw, what you did to gather that information and how valuable that information is. (See “[Braiding The Stories](http://www.developsense.com/blog/2012/02/braiding-the-stories/){:target="_blank"}” by Michael Bolton). The testing story contains three stories that feed into each other:
